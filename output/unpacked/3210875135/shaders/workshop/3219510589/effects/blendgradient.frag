...
uniform vec3 g_EdgeColor; // {"default":"1 0.75 0","label":"ui_editor_properties_edge_color","material":"edgecolor","type":"color"}
...
uniform sampler2D g_Texture2; // {"default":"util/clouds_256","label":"ui_editor_properties_gradient_mask","mode":"opacitymask","paintdefaultcolor":"0 0 0 1"}
uniform sampler2D g_Texture3; // {"combo":"OPACITYMASK","default":"util/white","label":"ui_editor_properties_opacity_mask","mode":"opacitymask","paintdefaultcolor":"0 0 0 1"}
