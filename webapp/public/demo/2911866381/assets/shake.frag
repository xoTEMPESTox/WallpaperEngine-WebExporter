...
uniform sampler2D g_Texture1; // {"default":"util/noflow","label":"ui_editor_properties_shake_direction_map","mode":"flowmask"}
uniform sampler2D g_Texture2; // {"default":"util/white","label":"ui_editor_properties_time_offset","mode":"opacitymask"}
...
uniform vec2 g_Friction; // {"default":"1 1","label":"ui_editor_properties_friction","linked":true,"material":"friction","range":[0.01,10.0]}
